(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_225c5e._.js", {
...
function ChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            const sockJS = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sockjs$2d$client$2f$lib$2f$entry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]('http://localhost:8080/ws');
    ...
    const fetchChatRooms = async ()=>{
        if (user) {
            const rooms = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].fetchChatRooms(user.email);
    ...
    const fetchOnlineUsers = async ()=>{
        if (user) {
            const onlineUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].fetchOnlineUsers();
    ...
    const selectChat = async (chatId, companionEmail)=>{
        if (!user) {
            return;
        }
        setCurrentChatId(chatId);
        setCurrentCompanion(companionEmail);
        const messages = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].fetchChatRoomMessages(user.email, companionEmail);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: currentChatId ? (chatRoomMessages.get(currentChatId) || []).map((message)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: `p-3 rounded max-w-[75%] ${message.sender === user.email ? "bg-blue-600 text-white ml-auto" : "bg-gray-800 text-gray-300"}`,
...
//# sourceMappingURL=src_225c5e._.js.map