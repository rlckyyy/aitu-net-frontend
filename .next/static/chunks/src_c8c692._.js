(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_c8c692._.js", {
        ...
        "Profile.useEffect": ()=>{
            const fetchUser = {
                "Profile.useEffect.fetchUser": async ()=>{
                    try {
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getUser();
                        setUser(data);
                        console.log('Ya tut');
                    } catch (error) {
...
_s(Profile, "J17Kp8z+0ojgAqGoY5o3BCjwWms=", false, function() {
    return [
...
//# sourceMappingURL=src_c8c692._.js.map