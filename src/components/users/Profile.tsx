...
import { api } from "@/lib";
import { Edit, Camera, Trash2, Mail, User, Users, Shield, FileText } from "lucide-react";
					...
					<div className="flex-1">
						...
						<div className="mt-6 space-y-4">
							...
							<div className="flex items-center">
								...
								<span className="text-gray-700 dark:text-gray-300">{user?.roles?.join(", ") || "Member"}</span>
							</div>
					...
					<div className="flex-1">
						<div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
							<div className="flex items-center justify-between mb-4">
								...
								<Link href="/friends/list" className="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">
									View all
								</Link>
							</div>
								...
								<div className="grid grid-cols-2 gap-3">
									{user.friendList.slice(0, 4).map((friend, index) => (
										...
										>
											...
											<span className="text-sm text-gray-700 dark:text-gray-300 truncate">{friend}</span>
										</div>
									))}
								</div>
							) : (
